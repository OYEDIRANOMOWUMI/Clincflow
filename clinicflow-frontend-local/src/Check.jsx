...
const Check = () => {
  ...
  const [rolePage] = useState('patient');
      ...
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        <div className="flex items-center cursor-pointer" onClick={() => setPage('home')}>
          ...
          <span className="text-2xl font-bold text-[#064E3B] tracking-tight">
            ClinicFlow<span className="text-emerald-700 font-light">Hospital</span>
          </span>
        </div>
        ...
        <div className="hidden md:flex items-center space-x-6">
          ...
          {session ? (
            ...
            <>
              <Link to="/admin" className="text-sm font-semibold text-stone-500 hover:text-[#064E3B] transition-colors">Login</Link>
      ...
      {isMenuOpen && (
        <div className="md:hidden absolute top-full left-0 w-full bg-[#F8F7F3] border-b border-stone-200 p-6 space-y-4 fade-in">
          ...
          {session ? (
            ...
            <>
              <Link to="/admin" onClick={() => setIsMenuOpen(false)} className="block w-full text-left font-bold text-[#064E3B]">Login</Link>
  ...
  const Hero = () => (
    <section className="bg-[#F8F7F3] py-16 lg:py-24 px-6 overflow-hidden relative">
      <div className="max-w-7xl mx-auto grid lg:grid-cols-[1.2fr_0.8fr] items-center gap-12">
        <div className="fade-in">
          ...
          <h1 className="text-5xl lg:text-7xl font-serif font-bold text-[#064E3B] mb-6 leading-[1.05]">
            Smarter care for
          ...
          <p className="text-lg text-stone-600 mb-9 leading-relaxed max-w-xl font-sans">
            ClinicFlow Hospital connects leading specialists, seamless scheduling, digital records, and compassionate care in one modern clinical experience.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-xl">
            {[
              ...
              <div key={stat.label} className="metric-card p-4 text-left">
          ...
          <div className="relative z-10 rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white transform rotate-2 hover:rotate-0 transition-transform duration-500">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
              <div className="flex items-center gap-2 text-green-100 mb-3">
                ...
                <span className="text-sm font-bold">ClinicFlow Hospital</span>
              </div>
    ...
    <section className="py-24 px-6 bg-white slide-up">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-stone-500 mt-6 max-w-2xl mx-auto">Led by visionaries in medicine and healthcare management, our team ensures ClinicFlow remains at the forefront of clinical excellence.</p>
        </div>
        ...
        <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-10 items-center">
          ...
          <div className="space-y-6">
            <p className="text-stone-600 leading-relaxed">
              ClinicFlow Hospital was built to give families a better healthcare experience—one that combines trusted specialists, streamlined digital records, and clean, patient-first support from admission to recovery.
            </p>
            <p className="text-stone-600 leading-relaxed">
        ...
        <div className="bg-[#064E3B] rounded-[2rem] p-8 text-stone-50 shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10 flex h-full flex-col justify-between">
            ...
            <div className="mt-8 flex items-center gap-2 text-sm font-semibold text-emerald-200">
              <ShieldCheck size={16} className="text-emerald-300" /> ClinicFlow Secure
            </div>
          </div>
        </div>
    ...
    <div className="min-h-screen bg-white font-sans">
          ...
          <div>
            ...
            <section className="py-20 px-6 max-w-7xl mx-auto slide-up">
              <div className="text-center mb-12">
                ...
                <h2 className="mt-4 text-4xl font-serif font-bold text-[#064E3B]">Complete medical care, all in one place</h2>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {[
                  ...
                  <div key={s.title} className="p-8 bg-stone-50 rounded-[2rem] border border-stone-100 hover:shadow-xl transition-all cursor-default">
      ...
      <footer className="bg-[#064E3B] text-stone-400 py-16 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 border-b border-emerald-900 pb-12 mb-8">
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center text-white font-bold text-xl mb-4">
               <Activity className="mr-2" size={20}/> ClinicFlow
            </div>
        ...
        <div className="text-center text-[10px] uppercase tracking-widest text-emerald-800">
          &copy; 2026 ClinicFlow Hospital Systems. Precision in Practice.
        </div>
      </footer>
        <ToastContainer />
    </div>

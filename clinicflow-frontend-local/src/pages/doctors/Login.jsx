...
import { saveSession, roleDashboardMap, getSession } from '../../auth';
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <select
                ...
                className="w-full bg-stone-50 border border-stone-200 rounded-xl py-3 px-4 focus:ring-2 focus:ring-emerald-900/10 outline-none transition-all"
              >
